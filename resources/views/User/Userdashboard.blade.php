...
<body>
    <header class="px-4 py-2 shadow-lg">
        <div class="flex justify-between">
            ...
            <div class="flex items-center">
                <button data-messages class="p-3 mr-2 focus:outline-none hover:bg-yellow-600 hover:rounded-md" typle="button">
                ...
                <button data-notifications class="p-3 mr-3 focus:outline-none hover:bg-yellow-600 hover:rounded-5blue" typle="button">
                ...
                <button data-dropdown class="flex items-center px-3 py-2 focus:outline-none hover:bg-yellow-600 hover:rounded-md" type="button" x-data="{ open: false }" @click="open = true" :class="{ 'bg-gray-200 rounded-md': open }">
                    <img src="src/img/1.png"  alt="Profile" class="h-8 w-8 rounded-full">
                    <span class="ml-4 text-sm hidden md:inline-block">User</span>
                    ...
                    <div data-dropdown-items class="text-sm text-left absolute top-0 right-0 mt-16 mr-4 bg-white rounded border border-yellow-400 shadow" x-show="open" @click.away="open = false">
                        <ul>
                            <li class="px-4 py-3 border-b hover:bg-yellow-600"><a href="{{ route('profile.edit') }}">Profile Settings</a></li>
                           <!-- <li class="px-4 py-3 border-b hover:bg-gray-200"><a href="#">Settings</a></li> -->
                            <li class="px-4 py-3 hover:bg-yellow-600"><a href="{{ route('logout') }}">Log out</a></li>
                        </ul>
                    </div>
                </button>
            </div>
    ...
    <div class="flex flex-row">
        <div class="flex flex-col w-64 h-screen overflow-y-auto bg-blue-600 border-r rtl:border-r-0 rtl:border-l dark:bg-black dark:border-gray-700 shadow-lg">
            <div class="sidebar text-center bg-blue-600 ">
                <div class="text-black text-xl">
                    <div class="p-2.5 mt-1 flex items-center">
                        <h1 class="font-bold text-gray-200 text-[15px] ml-3"></h1>
                    </div>
            ...
            <a href="{{ route('Home') }}">
                ...
                <a href="#">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-yellow-600 text-white">
                        <i class="bi-folder-symlink-fill"></i>
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">Unggah Dokumen</span>
                    </div>
                    <a href="#">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-yellow-600 text-white">
                        <i class="bi-file-person-fill"></i>
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">Informasi Bimbingan</span>
                    </div>
                </a>
                <a href="{{ route('profile.edit') }}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-yellow-600 text-white">
                        <i class="bi-people-fill"></i>
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">Pengaturan Profile</span>
                    </div>
                </a>
                <a href="{{ route('profile.edit') }}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-yellow-600 text-white">
                        <i class="bi-people-fill"></i>
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">Pilih Dosen Pembimbing</span>
                    </div>
                </a>
                <a href="{{ route('logout') }}">
